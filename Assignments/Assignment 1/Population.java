...
public class Population {
     ...
     * is then created from the two parents, using the method <code>crossover</code>. With probability <code>MUTATION_RATE</code>, the
     * offspring is <code>mutated</code>. Use 0.8 as the default <code>MUTATION_RATE</code> The resulting child is inserted into the
